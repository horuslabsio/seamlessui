...
export default function Home() {
  ...
  return (
    <main className="min-h-svh">
      <Gradient />
      <section className="mx-auto flex max-h-[100vh] justify-between pt-[12rem] seamlessui-container">
        <div className="basis-[55%] px-8">
          <h1 className="mb-8 max-w-[700px] text-6xl font-extrabold leading-[1.25]">
